...
$query_lista_categoria = "SELECT * FROM jogo WHERE id_categoria = {$id_categoria}";
$lista_categoria = mysqli_query($conn,$query_lista_categoria);
...
if($jogos->num_rows == 0) {
    ...
    while($jogo = mysqli_fetch_array($jogos)) {
        ...
        $query_excluir_jogo_idioma = "DELETE FROM jogo WHERE id = {$id_jogo}";
